...
from MedicOOD.generate_data.generator import ImageGenerator
...
if __name__ == '__main__':
    ...
    for split in splits.keys():
        ...
        for k in range(n_samples):
            ...
            if split == 'test_ood':
                # make data OOD by adding noise
                tr = tio.RandomMotion(num_transforms=3, p=1.)
                tio_img = tio.ScalarImage(path2img)
                out_img = tr(tio_img)
                out_img.save(path2img)
